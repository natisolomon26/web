...
export default function CTA() {
  return (
    <section className="relative overflow-hidden rounded-3xl bg-white shadow-sm">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-8 py-14 md:px-14 md:py-20 text-center">
        {/* Heading */}
        <motion.h2
        ...
        >
          <Link
            href="/donate"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-red-500 px-8 py-3 text-sm font-semibold text-white hover:bg-red-600 transition"
          >
            Donate
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center rounded-full border border-red-300 px-8 py-3 text-sm font-medium text-slate-700 hover:bg-red-50 transition"
          >
            Contact Us
          </Link>
        </motion.div>
        ...
        >
          {[
            ...
            <Link
              key={index}
              href={href}
              className="p-3 rounded-full bg-red-100 text-red-600 hover:bg-red-100 hover:text-red-600 transition"
            >
